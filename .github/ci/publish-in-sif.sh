...
# (project=scitex-str, owner=ywatanabe1989, repo=scitex-str,
...
TMPDIR="/tmp/publish-scitex_str-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-str dist/* uploaded to PyPI via manual OIDC trusted publishing"
